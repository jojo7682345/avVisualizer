 ...
 */
typedef bool8 (*onEventCallback)(uint16 code, void* sender, void* listener_inst, EventContext data);
 ...
 */
AV_API bool8 eventRegister(uint16 code, void* listener, onEventCallback on_event);
 ...
 */
AV_API bool8 eventUnregister(uint16 code, void* listener, onEventCallback on_event);
 ...
 */
AV_API bool8 eventFire(uint16 code, void* sender, EventContext context);
