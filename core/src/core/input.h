 ...
 */
bool8 inputSystemInitialize(uint64* memory_requirement, void* state, void* config);
 ...
 */
AV_API void inputKeyRepeatsEnable(bool8 enable);
 ...
 */
AV_API bool8 inputIsKeyDown(Keys key);
 ...
 */
AV_API bool8 inputIsKeyUp(Keys key);
 ...
 */
AV_API bool8 inputWasKeyDown(Keys key);
 ...
 */
AV_API bool8 inputWasKeyUp(Keys key);
 ...
 * @returns True if currently pressed; otherwise false.
 */
AV_API bool8 inputIsButtonDown(Buttons button);
 ...
 * @returns True if currently released; otherwise false.
 */
AV_API bool8 inputIsButtonUp(Buttons button);
 ...
 */
AV_API bool8 inputWasButtonDown(Buttons button);
 ...
 * @returns True if previously released; otherwise false.
 */
AV_API bool8 inputWasButtonUp(Buttons button);
 ...
 */
AV_API bool8 inputIsButtonDragging(Buttons button);
 ...
 */
AV_API void inputGetMousePosition(int32* x, int32* y);
 ...
 */
AV_API void inputGetPreviousMousePosition(int32* x, int32* y);
 ...
 * @return const char*
 */
AV_API const char* inputKeycodeStr(Keys key);
...
//  */
// AV_API void input_keymap_push(const struct keymap* map);
...
//  */
// AV_API bool8 input_keymap_pop(void);
