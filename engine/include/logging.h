...
#define AV_LOG_SUCCESS_DEFAULT 1
...
#ifndef NDEBUG
#define avLog(result, message, ...) avLog_(result,AV_LOCATION_PARAMS, AV_LOG_CATEGORY, message __VA_OPT__(,) __VA_ARGS__)
#define avAssert(result, expected, message, ...) avAssert_(result, expected,AV_LOCATION_PARAMS, AV_LOG_CATEGORY, message  __VA_OPT__(,) __VA_ARGS__)
#define avFatal(message, ...) avAssert_(AV_ERROR, AV_SUCCESS, AV_LOCATION_PARAMS, AV_LOG_CATEGORY, message __VA_OPT__(,) __VA_ARGS__)
#else 
